...
export const leadListDescription: INodeProperties[] = [
	{
		...
		description: 'Whether to list leads by Board or by Column',
	},
	{
	...
	},
	{
		...
		default: '',
		description: 'The Column ID to list leads from. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
	},
	{
		...
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'Text to search for leads',
			},
			{
